...
export default function SignupModal({setLoginModal}) {
  return (
    <div className=" overflow-y-scroll rounded-t-xl md:rounded-none mt-[56px] md:mt-0 w-[100%] left-0  md:w-[600px] h-screen  bg-[#f9f9f9] fixed  md:left-[50%] top-0 md:top-[50%]   md:translate-x-[-50%] md:translate-y-[-50%] shadow-2xl z-50">
      ...
      <div className="bg-white px-[6%] py-4 mt-3 ">
        ...
        <form className="mt-6">
          ...
          <div className=" border py-3 mt-1">
          ...
          <label for="link-checkbox" className=" border w-full ms-2 text-[13px] font-medium text-gray-900 dark:text-gray-300 ">
