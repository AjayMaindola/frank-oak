...
export default function LoginModal({setLoginModal,}) {
  return (
    ...
    <div className='bg-red-300 rounded-t-xl md:rounded-none mt-[56px] md:mt-0 w-[99%] left-[0.5%]  md:w-[600px] h-screen  md:bg-white fixed  md:left-[50%] top-0 md:top-[50%]   md:translate-x-[-50%] md:translate-y-[-50%] shadow-2xl z-50'>
