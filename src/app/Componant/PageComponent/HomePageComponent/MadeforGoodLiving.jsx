...
export default function MadeforGoodLiving() {
  return (
    <>
      <div className="w-full px-[10px] md:px-[10px] md:grid md:grid-cols-[50%_50%] md:mt-8  top-3">
        <div className=" max-w-[1320px] mx-auto   ">
          <h1 className="font-bold text-[20px] text-center py-4 mt-[35px]  md:py-10 lg:py-14 mb-2 md:mb-5  lg:text-start lg:px-6 lg:text-[25px] xl:px-14">
