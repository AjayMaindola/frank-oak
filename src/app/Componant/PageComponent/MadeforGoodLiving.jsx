      ...
      <div className="w-full md:px-[10px] md:grid md:grid-cols-[50%_50%] mt-0 md:mt-[40px]  ">
        <div className="mt-[20px]  md:mt-[70px]">
          ...
          <div className="mt-[30px] md:pt-[0px] lg:pt-[20px]">
            ...
            <p className=" mt-[30px] text-[18px] px-[30px] md:pt-[30px] md:text-[18px] md:text-justify md:px-[40px]  lg:pt-[50px]  tracking-wide text-justify lg:text-[22px]  lg:px-[100px] md:leading-[35px] lg:leading-[45px] font-medium">
